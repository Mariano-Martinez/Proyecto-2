    ...
    <AppShell>
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-12">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-3 rounded-full border border-subtle bg-layer-1 px-3 py-2 shadow-depth-sm">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="rounded-full border border-[hsl(var(--success)/0.3)] bg-[hsl(var(--success)/0.16)] px-2 py-1 text-[10px] font-bold uppercase text-[hsl(var(--success))]">
                Ahorra 15%
              </span>
            </div>
          </div>
        ...
        <section className="grid gap-4 lg:grid-cols-3">
          <div className="card p-5 lg:col-span-2">
            ...
            <div className="mt-4 space-y-3">
              {faqs.map((item) => (
                <div key={item.q} className="rounded-xl border border-subtle bg-layer-0 p-4 shadow-inset">
          ...
          <div className="card flex flex-col gap-3 p-5">
            ...
            <div className="rounded-xl border border-[hsl(var(--primary)/0.3)] bg-[hsl(var(--primary)/0.12)] p-4 text-primary">
