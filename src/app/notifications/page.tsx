...
export default function NotificationsPage() {
  ...
  return (
    <AppShell>
      <motion.div
        className="mx-auto flex max-w-2xl flex-col items-center gap-4 rounded-2xl border border-dashed border-[rgb(var(--border))] bg-[rgb(var(--panel-bg))] p-10 text-center"
        variants={fadeInUp}
        initial="initial"
        animate="animate"
      >
