    ...
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/40 px-4 backdrop-blur-sm">
      <div className="card w-full max-w-lg border-subtle bg-layer-1 p-6 shadow-depth-lg">
        <div className="flex items-center justify-between">
          ...
          <button onClick={onClose} className="rounded-full p-2 text-muted hover:bg-[hsl(var(--surface-2))] focus-visible:focus-ring">
        ...
        <form className="mt-4 space-y-4" onSubmit={submit}>
          ...
          {warning && (
            <div className="rounded-xl border border-[hsl(var(--primary)/0.25)] bg-[hsl(var(--primary)/0.14)] px-3 py-2 text-sm text-primary">
              <p>{warning}</p>
          ...
          {!loading && pendingShipmentId && (
            <div className="flex items-center justify-between rounded-xl border border-subtle bg-layer-0 px-3 py-2 text-xs text-muted shadow-inset">
