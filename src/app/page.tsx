...
export default function HomePage() {
  ...
  const providerBtn =
    'flex h-12 w-full items-center gap-3 rounded-full border border-subtle bg-surface-1 px-4 text-sm font-semibold text-default shadow-depth-sm transition hover:-translate-y-0.5 hover:shadow-depth-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--ring)/0.35)]';
  ...
  return (
    <main className="gradient-page flex min-h-screen flex-col">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-14 px-4 py-12">
        <section className="gradient-hero relative overflow-hidden rounded-[28px] border border-subtle bg-[hsl(var(--surface-0)/0.9)] px-6 py-12 shadow-depth-lg backdrop-blur animate-float">
          ...
          <div className="grid items-start gap-10 lg:grid-cols-2">
            ...
            <div className="glass-panel relative overflow-hidden rounded-[28px] px-6 py-8 animate-float">
              ...
              <div className="mt-6 space-y-3">
                <button type="button" className={providerBtn} onClick={() => handleSocial('Google')}>
                  <span className="flex h-8 w-8 items-center justify-center rounded-full bg-surface-2 shadow-inset">
        ...
        <section className="rounded-3xl border border-subtle bg-[hsl(var(--surface-0)/0.96)] p-6 shadow-depth-lg backdrop-blur">
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4 rounded-2xl border border-subtle bg-[hsl(var(--surface-0)/0.96)] p-6 sm:grid-cols-3 md:grid-cols-4 shadow-depth-sm">
