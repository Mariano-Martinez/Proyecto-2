    ...
    <div className="card hover-lift">
      ...
      <div className="mt-3 flex items-center justify-between">
        <div>
          ...
          <p className="rounded-lg border border-subtle bg-[rgba(0,0,0,0.45)] px-2 py-1 font-mono text-sm text-strong">
            {shipment.code}
          </p>
        </div>
        <button
          onClick={() => copy(shipment.code)}
          className="rounded-lg p-2 text-muted transition hover:bg-[rgba(255,255,255,0.08)] hover:text-strong focus-visible:focus-ring"
          title="Copiar código"
        >
      ...
      <div className="mt-3 flex items-center justify-between">
        ...
        <button
          ...
          className="text-sm font-semibold text-[rgba(255,76,76,0.95)] transition hover:text-[rgba(255,76,76,0.85)]"
          title="Eliminar"
        >
