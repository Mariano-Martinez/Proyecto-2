  ...
  return (
    <main className="gradient-page flex min-h-screen flex-col">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-14 px-4 py-12">
        <section className="gradient-hero relative overflow-hidden rounded-3xl border border-subtle bg-layer-1 px-6 py-12 shadow-depth-lg">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-start">
            <div className="inline-flex items-center gap-3 rounded-full border border-subtle bg-layer-0 px-4 py-2 text-strong shadow-depth-sm">
          ...
          <div className="grid items-start gap-10 lg:grid-cols-2">
            <div className="space-y-6">
              ...
              <div className="grid gap-3 md:grid-cols-2">
                <div className="rounded-2xl border border-subtle bg-layer-0 p-4 text-sm text-primary shadow-depth-sm">
                  <p className="font-semibold text-strong">Visibilidad total</p>
                  <p>Dashboard, tabla y cards mobile con métricas por estado.</p>
                </div>
                <div className="rounded-2xl border border-subtle bg-layer-0 p-4 text-sm text-[hsl(var(--success))] shadow-depth-sm">
              ...
              <div className="flex items-center gap-4 text-sm text-muted">
                <div className="flex items-center gap-2">
                  {[1, 2, 3].map((i) => (
                    <span
                      key={i}
                      className="h-8 w-8 rounded-full border border-subtle bg-layer-0 shadow-inset"
                      aria-hidden
                    />
                  ))}
                </div>
            ...
            <div className="card relative overflow-hidden rounded-3xl border-subtle bg-layer-1 px-6 py-8 shadow-depth-lg">
        ...
        <section className="rounded-3xl border border-subtle bg-layer-1 p-6 shadow-depth-md">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-3">
            {[1, 2, 3].map((step) => {
              ...
              return (
                <div key={step} className="flex h-full flex-col gap-2 rounded-2xl border border-subtle bg-layer-0 p-4 shadow-inset">
        ...
        <section className="space-y-6">
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            ...
            <span className="rounded-full border border-subtle bg-layer-0 px-4 py-2 text-sm font-semibold text-muted shadow-inset">+5 más</span>
          </div>
          <div className="grid grid-cols-2 gap-4 rounded-2xl border border-subtle bg-layer-1 p-6 shadow-depth-sm sm:grid-cols-3 md:grid-cols-4">
            {couriers.map((courier) => (
              <div
                key={courier.name}
                className="flex flex-col items-center justify-center gap-2 rounded-xl border border-subtle bg-layer-0 p-4 text-sm font-semibold text-muted shadow-inset"
              >
